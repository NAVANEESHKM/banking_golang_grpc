...
type CustomerServiceClient interface {
	...
	UpdateCustomer(ctx context.Context, in *CustomerDetails, opts ...grpc.CallOption) (*CustomerDetailsResponse, error)
}
...
func (c *customerServiceClient) UpdateCustomer(ctx context.Context, in *CustomerDetails, opts ...grpc.CallOption) (*CustomerDetailsResponse, error) {
...
type CustomerServiceServer interface {
	...
	UpdateCustomer(context.Context, *CustomerDetails) (*CustomerDetailsResponse, error)
...
func (UnimplementedCustomerServiceServer) UpdateCustomer(context.Context, *CustomerDetails) (*CustomerDetailsResponse, error) {
...
func _CustomerService_UpdateCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).UpdateCustomer(ctx, req.(*CustomerDetails))
	}
	return interceptor(ctx, in, info, handler)
}
